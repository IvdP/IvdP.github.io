...
export class Contact extends MithrilTsxComponent<{}> {
  view() {
    return <div id='contact'>
      <div class='contact-section'>
        ...
        <div class='icons'>
          <a href='https://www.linkedin.com/in/ilsevandepeppel/' target='_blank'><i class="fa fa-linkedin" aria-hidden="true"></i></a>
